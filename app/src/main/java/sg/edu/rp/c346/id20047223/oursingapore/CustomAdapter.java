...
public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Island currentVersion = songList.get(position);

        // Set values to the TextView to display the corresponding information
        tvName.setText(currentVersion.getIslandName());
        tvDesc.setText(currentVersion.getIslandDesc());
        tvArea.setText(currentVersion.getIslandArea() + "");
